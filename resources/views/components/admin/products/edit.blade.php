...
<div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex mb-6" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        <span class="text-gray-400">/</span>
                        <a href="{{ route('admin.products.show', $product) }}" class="ml-1 text-gray-700 hover:text-gray-900 md:ml-2">{{ $product->name }}</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select name="is_active" id="is_active" required
                                ...
                                <option value="0" {{ old('is_active', $product->is_active) == '0' ? 'selected' : '' }}>Inactivo</option>
                                <option value="1" {{ old('is_active', $product->is_active) == '1' ? 'selected' : '' }}>Activo</option>
                            </select>
                            @error('is_active')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="number" name="weight" id="weight" step="0.001" min="0" value="{{ old('weight', $product->weight) }}"
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 border-b border-gray-200 sm:px-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Imágenes Actuales</h3>
                    <p class="mt-1 text-sm text-gray-500">Gestiona las imágenes existentes del producto</p>
                </div>
                <div class="px-4 py-5 sm:p-6">
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 border-b border-gray-200 sm:px-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Agregar Nuevas Imágenes</h3>
                    <p class="mt-1 text-sm text-gray-500">Sube nuevas imágenes del producto</p>
                </div>
                <div class="px-4 py-5 sm:p-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Nuevas Imágenes del Producto</label>
